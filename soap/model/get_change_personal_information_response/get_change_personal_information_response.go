...
package get_change_personal_information_response

import "encoding/xml"

type GetChangePersonalInformationResponse struct {
    XMLName xml.Name `xml:"Get_Change_Personal_Information_Response"`
...
type ResponseData struct {
    ChangePersonalInformation *ChangePersonalInformation `xml:"Change_Personal_Information,omitempty"`
}

type ChangePersonalInformation struct {
    PersonReference *PersonReference `xml:"Person_Reference,omitempty"`
    ChangePersonalInformationData *ChangePersonalInformationData `xml:"Change_Personal_Information_Data,omitempty"`
}
...
type PersonalInformationData struct {
    ...
    HispanicOrLatinoForVisualSurvey *bool `xml:"Hispanic_or_Latino_for_Visual_Survey,omitempty"`
